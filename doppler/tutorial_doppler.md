...
` ` `bash
# Adiciona a chave GPG do Doppler
curl -sLf --retry 3 --retry-delay 3 https://packages.doppler.com/public/cli/gpg.823B70958367733E.key | sudo gpg --dearmor -o /usr/share/keyrings/doppler-archive-keyring.gpg

# Adiciona o repositório oficial à lista de fontes do APT
